...
module.exports.initialize = function initQP(schema) {
    ...
    grammar.lex.rules.unshift([ '(' + Object.keys(schema.indexes).join('|') + ')\\:', "return 'INDEX';" ]);
    grammar.lex.rules.unshift([ '(' + Object.keys(schema.indexes).join('|') + ')' + config.operators.FACET_START, "return 'FACET_START';" ]);
