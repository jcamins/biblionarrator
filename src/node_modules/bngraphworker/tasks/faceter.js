...
module.exports = function (input, callback) {
    ...
    for (var ii = 0; ii < input.records.length; ii++) {
        if (typeof input.records[ii] === 'string' && input.records[ii].substring(0, 2) === 'v[') {
    ...
    callback({ relationships: relationshipfacet, facets: facetarray, faceter: input.faceter || 'standard', count: input.count || 0 });
};
