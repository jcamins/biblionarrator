...
function handleOptimizedQuery(input, plan, callback) {
    if (plan.esquery) {
        ...
        plan.esquery.query.bool.should = plan.esquery.query.bool.should || [ ];
        plan.esquery.query.bool.should = plan.esquery.query.bool.should.concat(environment.esclient.relevance_bumps);
