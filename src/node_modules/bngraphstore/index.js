...
var db;
var engine;
var schema = require('bn-schema-common');
...
module.exports = function graph(opts) {
    ...
    if (typeof opts !== 'undefined') {
        if (typeof opts.schema !== 'undefined') {
            module.exports.config = opts.schema;
            extend(true, module.exports.config, require('bn-schema-common'));
        }
        for (var opt in opts) {
