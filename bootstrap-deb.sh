...
apt-get install -y redis-server mongodb nodejs maven make g++ git vim libyaz4-dev
wget -q https://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-0.90.7.deb
